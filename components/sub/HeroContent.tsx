    ...
    >
      <div className="h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 mt-6 text-6xl font-bold text-white max-w-[640px] w-auto h-auto"
        >
          <span>
            {" "}
            Providing
        ...
        >
          I&apos;m a Fullstack Developer Software Engineer with experience in
